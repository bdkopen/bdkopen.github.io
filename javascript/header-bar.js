...
headerbar.innerHTML = '<div class="dropdown"><a href="/"><button class="dropbtn">Home</button></a></div><div class="dropdown"><button class="dropbtn">Random</button><div class="dropdown-content"><a href="/random/infinite_lawn_mower/">The Infinite Lawn Mower</a><a href="/random/lava_lamp/">The ASCII Lava Lamp</a><a href="#">Coming soon...</a></div></div><div class="dropdown"><button class="dropbtn">Tools</button><div class="dropdown-content"><a href="/tools/nameGenerator/">Name Generator</a><a href="/tools/encrypter/">Message Encrypter</a><a href="/tools/encrypter/ebayFeeCalc">eBay Fee Calculator</a><a href="#">Coming soon...</a></div></div></div></div>';