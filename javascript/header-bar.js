...
headerbar.innerHTML = '<div class="dropdown"><a href="/"><button class="dropbtn">Home</button></a></div><div class="dropdown"><button class="dropbtn">Games</button><div class="dropdown-content"><a href="/universes/">Universe Generator</a><a href="#">Coming soon...</a></div></div><div class="dropdown"><button class="dropbtn">Tools</button><div class="dropdown-content"><a href="/tools/nameGenerator/">Name Generator</a><a href="#">Coming soon...</a></div></div><div class="dropdown"><button class="dropbtn">ELM</button><div class="dropdown-content"><a href="/elm/manyvery/">The Many Very&#39;s</a><a href="#">Coming soon...</a></div></div>';